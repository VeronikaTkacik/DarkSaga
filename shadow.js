...
const scenes = [
  {
    id: 1,
    description: "Ти прокидаєшся у темних лісах Півночі. Темрява глибока, і з кожним кроком ти все більше відчуваєш присутність чогось жахливого. Ти бачиш дві стежки. Який шлях вибрати?",
    options: [
  ...
  {
    id: 2,
    description: "Ти відчуваєш, як темрява огортає тебе. Раптом на твоєму шляху з'являється ворог — темний воїн, охоронець таємниць цього лісу. Як діяти?",
    options: [
      { text: "Проти них використати заборонену магію Тіні", nextScene: 4 },
      { text: "Вступити в бій зі зброєю", nextScene: 5 }
    ]
  },
  {
    id: 3,
    description: "Ти підходиш до храму, що здалеку виглядав спокійно. Але коли ти наближаєшся, з його вікон заливає тебе темне світло. Який твій вибір?",
    options: [
  ...
  {
    id: 5,
    description: "Ти вступаєш в бій і вбиваєш темного воїна, але відчуваєш, що кожен твій удар збільшує твою залежність від Тіні. Як бути далі?",
    options: [
  ...
  {
    id: 7,
    description: "Ти відмовляєшся від артефакту і повертаєшся до лісу. Однак, по шляху тебе наздоганяє сила, що манить тебе назад у темряву. Що робити?",
    options: [
  ...
  {
    id: 8,
    description: "Ти відчуваєш, як темна сила охоплює тебе. Тепер ти стоїш перед Клинком Безодні. Ти можеш підкорити цей артефакт, але з ціною. Що робити?",
    options: [
